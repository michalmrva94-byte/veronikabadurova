...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Potvrďte svoj email – Veronika Swim',
  invite: 'Pozvánka do Veronika Swim',
  magiclink: 'Váš prihlasovací odkaz – Veronika Swim',
  recovery: 'Obnovenie hesla – Veronika Swim',
  email_change: 'Potvrdenie zmeny emailu – Veronika Swim',
  reauthentication: 'Váš overovací kód – Veronika Swim',
}
...
// Configuration
const SITE_NAME = "veronikabadurova"
const SENDER_DOMAIN = "notify.veronikaswim.sk"
const ROOT_DOMAIN = "veronikaswim.sk"
const FROM_DOMAIN = "veronikaswim.sk" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://veronikabadurova.lovable.app"
