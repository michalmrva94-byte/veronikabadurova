    ...
    <Body style={main}>
      <Container style={container}>
        ...
        {trainingCount && trainingCount > 1 ? (
          <Text style={text}>
            Veronika ti navrhla <strong>{trainingCount} tréningov</strong>. Prvý je naplánovaný na <strong>{trainingDate}</strong> o <strong>{trainingTime}</strong>. Potvrď ich najneskôr 3 hodiny pred tréningom.
          </Text>
        ) : (
          <Text style={text}>
            Veronika ti navrhla tréning na <strong>{trainingDate}</strong> o <strong>{trainingTime}</strong>. Potvrď ho najneskôr 3 hodiny pred tréningom.
          </Text>
        )}
        <Section style={warningBox}>
          <Text style={warningText}>⏰ Potvrď najneskôr 3 hodiny pred tréningom, inak sa termín automaticky uvoľní.</Text>
        </Section>
