...
export const ConfirmationEmail = ({ clientName, trainingDate, trainingTime, appUrl }: Props) => (
  <Html>
    <Head />
    <Preview>Váš tréning je potvrdený — Veronika Swim</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Tréning potvrdený ✅</Heading>
